...
?>
    ...
    <div class="row container" style="margin-top: 30px;">
        ...
        <div class="tatutop col s12 m8 offset-m2">
            <div class="card red">
                <div class="card-content white-text">
                    <span class="card-title"><p style="text-align:center"><b>VALORES <i class="material-icons">star</i></b></p></span>
                    <p>Transparência com os nossos clientes, equipe comprometida e apaixonada pelo que faz e responsabilidade social em nossa atuação.<br><br></p>
                </div>
            </div>
        </div>
    </div>
